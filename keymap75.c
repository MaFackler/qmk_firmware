...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_75_iso(
        _______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        ...
        _______, _______, _______, _______, BL_ON,  BL_TOGG, BL_STEP,  BL_STEP, _______, _______, _______, _______, _______,          _______, _______,
